...
class OpportunityScanner:
    ...
    def scan(
        ...
        corporate_events: list[dict] | None = None,
        news_articles: list[dict] | None = None,
        stock_data_cache: dict[str, pd.DataFrame] | None = None,
    ) -> list[ScanResult]:
        """
    ...
    def scan_with_summary(
        ...
        logger.info(
            f"Scan complete: {summary.actionable} actionable, "
...
if __name__ == "__main__":
    ...
    assert (
        len(infy_rejections) == 1 and infy_rejections[0].category == "hold"
